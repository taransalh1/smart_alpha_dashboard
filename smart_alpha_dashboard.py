...
try:
    ...
    st.error("❌ Failed importing core modules:")
...
try:
    ...
    for _, r in alpha_map.iterrows():
        ...
        # Quick klines and percentage changes
        try:
    ...
    fig = px.bar(df.head(topn), x="symbol", y="alpha_score", color="alpha_score", color_continuous_scale="Viridis")
    st.plotly_chart(fig, use_container_width=True)

    st.markdown("### Market Cap vs 24h Volume")
    scat = px.scatter(df.head(topn), x="market_cap_usd", y="quoteVolume_24h",
